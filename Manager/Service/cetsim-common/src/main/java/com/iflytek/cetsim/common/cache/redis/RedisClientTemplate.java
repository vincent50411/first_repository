...
public class RedisClientTemplate {
    ...
    //    redisClientTemplate.hset("mymap", "key1", "value1");
    //    redisClientTemplate.hset("mymap", "key2", "value2");
    //    String mymapValue = redisClientTemplate.hget("mymap", "key2");
    //    System.out.println(mymapValue);
    //    Map mymapValues = redisClientTemplate.hgetAll("mymap");
