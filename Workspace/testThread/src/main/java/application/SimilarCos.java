...
public class SimilarCos
{
    ...
    public static void main(String args[])
    {
        ...
        String str5 = "高血压病 定义 为： 在 未 使用 降压 药物 的 情况 下，非 同日 3 次 测量 血压，收缩压 ≥ 140 mmHg（1 mmHg＝0.133 kPa）和（或）舒张压 ≥ 90 mmHg";
        String str6 = "高血压病 的 叫法  为： 在 未 使用 降压 药物 的 情况 下，非 同日 3 次 测量 血压，( 收缩压 ≥ 140 mmHg（1 mmHg＝0.133 kPa）和（或）舒张压 ≥ 90 mmHg";
